...
<div class="row">
	<div class="col-md-12">
		<h2 class="page-header">Publication de la société</h2>
		...
		<div id="success_msg" style="display:none;">
			<div class="alert alert-success">
				<h4><i class="icon-trophy" style="font-size:150%;"></i>&nbsp;&nbsp;Félicitations, la société é été bien publiée</h4>
				<p>
					Accusé de paiment:
		...
		<div id="already_done_msg" style="display:none;">
			<div class="alert alert-info">
				<h4><i class="icon-info" style="font-size:150%;"></i>&nbsp;&nbsp;Vous avez déja publié la société</h4>
				<p>
					Accusé de paiment:
					<strong class="payment_recipt"></strong>
				</p>

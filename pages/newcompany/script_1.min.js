...
url:{minlength:5,remote:{url:location.href,type:"post",data:{check_url:function(){return $("[name=url]",b).val()}}}},address:{required:!0},longitude:{required:!0},latitude:{required:!0},tel:{required:!0},email:{required:!0}},invalidHandler:function(a,c){e.show()},highlight:function(a){$(a).closest(".form-group").removeClass("has-success").addClass("has-error")},unhighlight:function(a){$(a).closest(".form-group").removeClass("has-error")},success:function(a){},errorPlacement:function(a,c){switch($(c).attr("name")){case "url":a.appendTo($(c.parents(".form-group")[0]).find(".error_msg"));
break;default:a.insertAfter(c)}},submitHandler:function(a){e.hide()}});$("[name='categories[]']",b).select2();b.submit(function(a){if(!b.valid())return a.preventDefault(),!1;$.ajax({url:location.href,type:"POST",data:$(b).serialize(),success:function(a){try{switch(p=JSON.parse(a),p.status){case "success":app.ajaxify(p.params.company_url);break;default:return console.log(p),!1}}catch(b){return console.log(a),!1}},error:function(a){console.log(a);return!1}})});$("[name=name]",b).focus()}});

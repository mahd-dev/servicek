<link href="<?php echo url_root;?>/pages/register/style.min.css" rel="stylesheet" type="text/css">
<div class="row">
	<div class="col-md-12">
...
<!-- custom page script -->
<script src="<?php echo url_root;?>/pages/register/script_1.min.js" type="text/javascript"></script>

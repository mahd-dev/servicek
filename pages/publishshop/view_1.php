<link href="<?php echo url_root;?>/pages/publishshop/style<?php if(!debug) echo ".min";?>.css" rel="stylesheet" type="text/css">

<div class="row">
	<div class="col-md-12">
		<h2 class="page-header">Publication de la boutique</h2>
		<div class="portlet light" id="page_wizard">
			<div class="portlet-body form">
				<form action="javascript:;" class="form-horizontal" id="submit_form" method="POST">
					<input type="hidden" name="token" value="<?php echo $new_shop_token;?>">
					<div class="form-wizard">
						<div class="form-body">
							<div class="navbar navbar-default steps">
								<ul class="nav navbar-nav nav-tabs">
									<li><a href="#contract_details" data-toggle="tab" class="step"><span class="number">1</span><span class="desc"> Détails du contrat </span></a></li>
									<li><a href="#payment_informations" data-toggle="tab" class="step"><span class="number">2</span><span class="desc"> Informations du paiement </span></a></li>
									<li><a href="#validation" data-toggle="tab" class="step"><span class="number">3</span><span class="desc"> Validation </span></a></li>
								</ul>
							</div>
							...
							<div class="tab-content box">
								...
								<div class="tab-pane" id="validation">
									...
									<div class="form-group">
										...
										<div class="col-md-6"><p><strong><?php echo $shop->name;?></strong></p></div>
									</div>

									<div class="form-group">
										<label class="control-label col-md-3">Description :</label>
										<div class="col-md-6"><p><strong><?php echo $shop->description;?></strong></p></div>
									</div>
						...
						<div class="form-actions">
							...
							<a href="javascript:;" class="btn btn-primary btn-lg button-submit pull-right">Valider et créer <i class="fa fa-check"></i></a>
						</div>
					</div>
				</form>
			</div>
		...
		<div id="success_msg" style="display:none;">
			<div class="alert alert-success">
				<h4><i class="icon-trophy" style="font-size:150%;"></i>&nbsp;&nbsp;Félicitations, la boutique é été bien publiée</h4>
				<p>
					Accusé de paiment:
					<strong class="payment_recipt"></strong>
				</p>
				<p>
					<a class="btn btn-success ajaxify goto_shop" href="<?php echo url_root;?>/account"><i class="icon-link"></i>&nbsp;&nbsp;Accéder à la boutique publiée</a>
				</p>
			</div>
		</div>
		...
		<div id="already_done_msg" style="display:none;">
			<div class="alert alert-info">
				<h4><i class="icon-info" style="font-size:150%;"></i>&nbsp;&nbsp;Vous avez déja publié la boutique</h4>
				<p>
					Accusé de paiment:
					<strong class="payment_recipt"></strong>
				</p>
...
<!-- custom page script -->
<script src="<?php echo url_root;?>/pages/publishshop/script_1<?php if(!debug) echo ".min";?>.js" type="text/javascript"></script>

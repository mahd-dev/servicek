				...
				<div class="profile-content col-md-12">
					<div class="tab-content box">
						<div class="tab-pane active" id="title1">
							<form action="javascript:;" id="job_submit_form" method="POST" action="<?php echo url_root;?>/new/job">
								<div class="form-group">
									<input type="text" class="form-control" name="job_name" placeholder="Nom du métier" data-msg-required="Ce champ est obligatoire"/>
								</div>
								<div class="form-group">
									<textarea class="form-control" name="job_description" placeholder="Expliquez brièvement le métier" data-msg-required="Ce champ est obligatoire" style="max-width:100%; min-with:100%;" rows="5"></textarea>
								</div>
								<div class="form-group">
								...
								<button type="submit" class="btn btn-lg btn-success">Créer le métier <i class="fa fa-check"></i></button>
							</form>
						</div>
						...
						<div class="tab-pane" id="title3">
							<form action="javascript:;" id="company_submit_form" method="POST" action="<?php echo url_root;?>/new/company">
								<div class="form-group">

...
$("#register_form").ajaxForm({beforeSubmit:function(){if($("#password_confirmation").val()!=$("#register_form input[name=password]").val())return!1},success:function(a){try{if(parsed=JSON.parse(a),"logged_in"==parsed.status)$(".top-menu .user-btn .username").text(parsed.params.displayname),$(".top-menu .login-btn").hide(),$(".top-menu .user-btn").show(),$("#register_form").remove(),g.submit();else if("username_exists"==parsed.status){var b=$("#register_form input[name=username]");b.closest(".form-group").removeClass("has-success").addClass("has-error");
...
$("#job_find_my_position").click(function(a){a.preventDefault();navigator.geolocation&&navigator.geolocation.getCurrentPosition(function(a){$("#job_submit_form [name=latitude]").val(a.coords.latitude).change();$("#job_submit_form [name=longitude]").val(a.coords.longitude).change()})});var d=$("#job_submit_form"),e=$(".alert-danger.form-error");d.validate({ignore:"",errorElement:"span",errorClass:"help-block help-block-error",focusInvalid:!0,rules:{name:{minlength:3,maxlength:255,required:!0},description:{minlength:50,
maxlength:4095,required:!0},categories:{required:!0},address:{required:!0},longitude:{required:!0},latitude:{required:!0},tel:{required:!0},email:{required:!0}},invalidHandler:function(a,b){e.show()},highlight:function(a){$(a).closest(".form-group").removeClass("has-success").addClass("has-error")},unhighlight:function(a){$(a).closest(".form-group").removeClass("has-error")},success:function(a){},errorPlacement:function(a,b){switch($(b).attr("job_name")){default:a.insertAfter(b)}},submitHandler:function(a){e.hide()}});
$("[name='categories[]']",d).select2();d.submit(function(a){if(!d.valid())return a.preventDefault(),!1;if(a.originalEvent&&1==$("#register_form").length)return $("#register_form").submit(),a.preventDefault(),!1;$.ajax({url:$(this).attr("action"),type:"POST",data:$(d).serialize(),success:function(a){try{switch(p=JSON.parse(a),p.status){case "success":app.ajaxify(p.params.job_url);break;default:return console.log(p),!1}}catch(c){return console.log(a),!1}},error:function(a){console.log(a);return!1}})});
navigator.geolocation||(c=$("#company_find_my_position").parents(".input-group"),c.before($("input",c)),c.remove());$("#company_geolocation").locationpicker({location:{latitude:33.881967,longitude:9.560764},radius:0,zoom:6,enableAutocomplete:!0,scrollwheel:!1,inputBinding:{locationNameInput:$("#company_submit_form [name=address]"),latitudeInput:$("#company_submit_form [name=latitude]"),longitudeInput:$("#company_submit_form [name=longitude]")}});$("#company_find_my_position").click(function(a){a.preventDefault();
navigator.geolocation&&navigator.geolocation.getCurrentPosition(function(a){$("#company_submit_form [name=latitude]").val(a.coords.latitude).change();$("#company_submit_form [name=longitude]").val(a.coords.longitude).change()})});var f=$("#company_submit_form"),e=$(".alert-danger.form-error");f.validate({ignore:"",errorElement:"span",errorClass:"help-block help-block-error",focusInvalid:!0,rules:{name:{minlength:3,maxlength:255,required:!0},description:{minlength:50,maxlength:4095,required:!0},categories:{required:!0},
url:{minlength:5,remote:{url:$("#register_form").attr("action"),type:"post",data:{check_url:function(){return $("[name=url]",company_).val()}}}},address:{required:!0},longitude:{required:!0},latitude:{required:!0},tel:{required:!0},email:{required:!0}},invalidHandler:function(a,b){e.show()},highlight:function(a){$(a).closest(".form-group").removeClass("has-success").addClass("has-error")},unhighlight:function(a){$(a).closest(".form-group").removeClass("has-error")},success:function(a){},errorPlacement:function(a,
b){switch($(b).attr("company_name")){case "url":a.appendTo($(b.parents(".form-group")[0]).find(".error_msg"));break;default:a.insertAfter(b)}},submitHandler:function(a){e.hide()}});$("[name='categories[]']",f).select2();f.submit(function(a){if(!f.valid())return a.preventDefault(),!1;if(a.originalEvent&&1==$("#register_form").length)return $("#register_form").submit(),a.preventDefault(),!1;$.ajax({url:$(this).attr("action"),type:"POST",data:$(f).serialize(),success:function(a){try{switch(p=JSON.parse(a),
p.status){case "success":app.ajaify(p.params.company_url);break;default:return console.log(p),!1}}catch(c){return console.log(a),!1}},error:function(a){console.log(a);return!1}})});$("#register_form input[name=displayname]").focus()}});

...
var app = function() {
  ...
  var handleAjaxify = function() {
      ...
      $(document).on('click', '.ajaxify', function(e) { // required : href; optional : data-method, data-params, data-container
        ...
        app.ajaxify(url, method, params, container, prevent_history_state);
      });

      // handle history popstate event
      $(window).bind("popstate", function(e) {
        var s = e.originalEvent.state;
        if (s) app.ajaxify(s.href, s.method, s.params, s.container, true);
        else app.ajaxify(location.href, undefined, undefined, undefined, true);
      });
    }
    //* END:CORE HANDLERS *//
  ...
  return {
    ...
    ajaxify: function(href, method, params, container, prevent_history_state) {
      ...
      var container = (container === undefined ? $('.main .container') : $(container));
